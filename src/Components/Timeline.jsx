...
const Timeline = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-4xl mx-auto min-h-screen  bg-cover bg-center bg-[url('images.png')] shadow-md rounded-lg p-6">
        <h1 className="text-4xl font-bold text-center mb-8">Our Journey</h1>
        <div className="relative">
         {/* centerline */}
          <div className="border-r-4 border-blue-600 absolute h-full top-0 left-1/2 transform -translate-x-1/2"></div>
            ...
            events.map((event, index) => (
              <li key={index} className={`mb-8 flex ${index % 2 === 0 ? "flex-row-reverse" : ""} items-center`}>
                ...
                <div className="w-1/2 flex justify-center relative">
                  <div className="bg-blue-500 h-8 w-8 rounded-full border-4 border-white absolute top-1/2 transform -translate-y-1/2"></div>
                </div>
              </li>
            ))
            }
